...
public class RoleService : IRoleService
{
    ...
    public RoleService(IServiceFactory serviceFactory)
    {
        ...
        _roleManager = _serviceFactory.GetService<RoleManager<AppRole>>();
        _roleRepo = _unitOfWork.GetRepository<AppRole>();
    ...
    {
        AppUser user = await _userManager.FindByNameAsync(request.UserName.Trim().ToLower());
    ...
    {
        AppUser user = await _userManager.FindByNameAsync(userName.Trim().ToLower());
        if (user == null)
